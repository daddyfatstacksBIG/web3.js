    ...
    [
      {
        ...
        transaction : {
          ...
          toIban : 'XE04S1IRT2PR8A8422TPBL9SR6U0HODDCUT', // will be switched to
                                                          // "to" in the test
          value : "1000000000",
          data : "",
          common : common
      ...
      },
      {
        ...
        messageHash :
            "0x21975b15072795e610d2937abcf15ed4aecd0650b8a62204274bef3b57a8501a"
      },
      {
        address : '0x2c7536E3605D9C16a7a3D7b1898e529396a65c23',
        iban : 'XE0556YCRTEZ9JALZBSCXOK4UJ5F3HN03DV',
      ...
      },
      {
        ...
        transaction : {
          ...
          toIban : 'XE4967QZMA14MI680T89KSPPJEJMU68MEYD', // will be switched to
                                                          // "to" in the test
      ...
      },
      {
        ...
        transaction : {
          ...
          toIban : 'XE63TIJX31ZHSLZ6F601ZPKVDKKYHMIK03G', // will be switched to
                                                          // "to" in the test
          value : "1000000000000000000",
          data : "0x0123abcd",
          common : common
        },
        // web3.eth.signTransaction({from:
        // "0xEB014f8c8B418Db6b45774c326A0E64C78914dC0", gasPrice:
        // "230000000000", gas: "50000", to:
        // '0xFCAd0B19bB29D4674531d6f115237E16AfCE377c', value:
        // "1000000000000000000", data: "0x0123abcd"}).then(console.log);
        // signature from eth_signTransaction
        rawTransaction :
  ...
  describe("accounts", function() {
    ...
    tests.forEach(function(test, i) {
      if (test.error) {
        ...
        it("signTransaction will call for nonce, gasPrice, chainId and networkId",
           function(done) {
             var provider = new FakeHttpProvider();
             var web3 = new Web3(provider);
        ...
        it("recoverTransaction, must recover signature", function() {
          ...
          testAccount.signTransaction(test.transaction).then(function(tx) {
            assert.equal(ethAccounts.recoverTransaction(tx.rawTransaction),
                         test.address);
          });
        });
        ...
        it("recoverTransaction, must also recover old signature from eth-signer",
           function() {
             ...
             var oldSignature =
                 ethjsSigner.sign(test.transaction, test.privateKey);

             assert.equal(ethAccounts.recoverTransaction(oldSignature),
                          test.address);
           });
      }
    });
