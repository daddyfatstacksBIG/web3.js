...
describe('web3.eth', function() {
  describe('transactionBlockTimeout', function() {
    it('should check if transactionBlockTimeout is set to proper value',
       function() {
    ...
    it('should set transactionBlockTimeout for all sub packages is set to proper value, if Eth package is changed',
       function() {
