...
var clone = function(
    object) { return object ? JSON.parse(JSON.stringify(object)) : []; };
          ...
          if (test.error) {
            if (obj) {
              ...
              if (test.defaultOptions) {
                test.defaultOptions.forEach(function(
                    option) { w3[option[0]] = option[1]; });
              }
            ...
            result.then(function(result) {
              if (test.notification) {
                ...
                assert.deepEqual(result, {
                  ...
                  "transactionIndex" : 1,
                  "contractAddress" :
                      "0x407D73d8a49eeb85D32Cf465507dd71d507100c1", // checksum
                                                                    // address
