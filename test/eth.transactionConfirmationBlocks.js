...
describe('web3.eth', function() {
  describe('transactionConfirmationBlocks', function() {
    it('should check if transactionConfirmationBlocks is set to proper value',
       function() {
    ...
    it('should set transactionConfirmationBlocks for all sub packages is set to proper value, if Eth package is changed',
       function() {
         ...
         assert.equal(eth.getCode.method.transactionConfirmationBlocks,
                      setValue);
       });
  });
});
