...
describe('web3.eth', function() {
  describe('transactionPollingTimeout', function() {
    it('should check if transactionPollingTimeout is set to proper value',
       function() {
    ...
    it('should set transactionPollingTimeout for all sub packages is set to proper value, if Eth package is changed',
       function() {
