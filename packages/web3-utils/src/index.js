...
/**
 * Should be used to flatten json abi inputs/outputs into an array of
 ...
 *
 * @method fromWei
 * @param {Number|String} number can be a number, number string or a HEX of a
 *     decimal
 * @param {String} unit the unit to convert to, default ether
 ...
 *
 * @method toWei
 * @param {Number|String|BN} number can be a number, number string or a HEX of a
 *     decimal
